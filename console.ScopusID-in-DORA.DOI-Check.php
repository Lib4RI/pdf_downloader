...
/*
	TASK/DESCRIPTION:
	For the given (Solr-query defined) amount of DORA publication find all those
	with a Scopus ID and with or without DOI ('comment-toggled')

	EXECUTION (bash command):
	php console.ScopusID-in-DORA.DOI-Check.php
	...
	$httpData = array(		/* just to pretend human browser behavior */
		'http' => array(
			'header' => array(	/* defaults, may be overwitten */
				'User-Agent: ' . 'Mozilla/5.0 (Lib4RI IT Services)',
...
// echo queryScopus( '2-s2.0-82755170946') . "\r\n";
// echo queryWoS( '000225079300029') . "\r\n";
...
foreach( $pidAry['response']['docs'] as $pIdx => $pAry ) {
	...
	echo  "\r\n" . $pid . " ::: " . print_r( $pAry['mods_identifier_scopus_mt'], 1 );
